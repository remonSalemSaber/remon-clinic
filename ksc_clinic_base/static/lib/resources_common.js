...
!function(e, r) {
    ...
    function s(e, r) {
        ...
        if (null == t) {
            ...
            n && (t = n.extendedProps.resourceEditable),
            null == t && null == (t = r.opt("eventResourceEditable")) && (t = r.opt("editable"))
        }
        return t
    }
    var i = function() {
    ...
    function u(e, t, n, s) {
        if (t) {
            ...
            return o(i, function(e, r) {
                var t = {};
                for (var n in e)
                    for (var o = void 0; (o = r[n]) && (n = o.parentId); )
                        t[n] = !0;
                return t
            }(i, e)),
            r.filterHash(e, (function(e, r) {
                return i[r]
            }
            ))
        }
    ...
    var a = function() {
        function e() {
            this.buildResourceEventUis = r.memoizeOutput(c, r.isPropsEqual),
            this.injectResourceEventUis = r.memoize(l)
        }
    ...
    function y(e, r, t) {
        if (e) {
            ...
            return !t && r.opt("refetchResourcesOnNavigate") || (n = E(n, null, r)),
            n
        }
        return null
    }
    function E(e, r, t) {
        var n, s = (n = e.sourceDefId,
        p[n]), i = String(R++);
        return s.fetch({
            resourceSource: e,
            calendar: t,
            ...
            t.afterSizingTriggers._resourcesRendered = [null],
            t.dispatch({
    ...
    function I(e, t, n, s) {
        ...
        if (u.id || (u.id = "_fc:" + S++),
        u.parentId || (u.parentId = t),
        u.businessHours = u.businessHours ? r.parseBusinessHours(u.businessHours, s) : null,
        u.ui = c,
        u.extendedProps = o({}, a, u.extendedProps),
        Object.freeze(c.classNames),
    ...
    function b(e, t, n, s) {
        ...
        case "REMOVE_RESOURCE":
            return function(e, r) {
                var t = o({}, e);
                for (var n in delete t[r],
                t)
                    t[n].parentId === r && (t[n] = o({}, t[n], {
                        parentId: ""
                    }));
                return t
            }(e, t.resourceId);
    ...
    var _ = function() {
        ...
        e.prototype.getChildren = function() {
            var r = this._resource.id
              ...
              , o = [];
            for (var s in n)
                n[s].parentId === r && o.push(new e(t,n[s]));
            return o
        }
        ,
        e.prototype.getEvents = function() {
            ...
            for (var u in s) {
                var a = s[u]
                  , c = o[a.defId];
                -1 !== c.resourceIds.indexOf(e) && i.push(new r.EventApi(t,c,a))
            }
            return i
        }
        ,
    ...
    r.Calendar.prototype.addResource = function(e, r) {
        var t, n, o;
        return void 0 === r && (r = !0),
        e instanceof _ ? ((t = {})[(o = e._resource).id] = o,
        n = t) : o = I(e, "", n = {}, this),
        r && this.component.view.addScroll({
            forcedRowId: o.id
        }),
        this.dispatch({
            type: "ADD_RESOURCE",
    ...
    r.Calendar.prototype.getTopLevelResources = function() {
        ...
        if (e)
            for (var t in e)
                e[t].parentId || r.push(new _(this,e[t]));
        return r
    }
    ,
    ...
    var w = function(e) {
        ...
        return n(r, e),
        r.prototype.getKeyInfo = function(e) {
            return o({
                "": {}
            }, e.resourceStore)
        }
    ...
    r.EventApi.prototype.setResources = function(e) {
        for (var r = [], t = 0, n = e; t < n.length; t++) {
            var o = n[t]
              , s = null;
            "string" == typeof o ? s = o : "number" == typeof o ? s = String(o) : o instanceof _ ? s = o.id : console.warn("unknown resource type: " + o),
            s && r.push(s)
        }
        this.mutate({
            standardProps: {
    ...
    h({
        ...
        fetch: function(e, t, n) {
            var s = e.resourceSource.meta
              , i = function(e, r, t) {
                var n, s, i, u, a = t.dateEnv, c = {};
                r && (n = t.opt("startParam"),
                s = t.opt("endParam"),
                i = t.opt("timeZoneParam"),
                c[n] = a.formatIso(r.start),
                c[s] = a.formatIso(r.end),
                "local" !== a.timeZone && (c[i] = a.timeZone));
    ...
    var F = function(e) {
        function t(t) {
            ...
            return n.processOptions = r.memoize(n._processOptions),
            n.parentEl = t,
            n
        }
        return n(t, e),
        t.prototype._processOptions = function(e, r) {
            this.datesAboveResources = e.datesAboveResources,
            this.resourceTextFunc = j(e.resourceText, r)
        }
        ,
        t.prototype.render = function(e, t) {
            var n, o = t.options, s = t.calendar, i = t.theme;
            this.processOptions(o, s),
            this.parentEl.innerHTML = "",
            this.parentEl.appendChild(this.el = r.htmlToElement('<div class="fc-row ' + i.getClass("headerRow") + '"><table class="' + i.getClass("tableGrid") + '"><thead></thead></table></div>')),
            this.thead = this.el.querySelector("thead"),
            this.dateFormat = r.createFormatter(o.columnHeaderFormat || r.computeFallbackHeaderFormat(e.datesRepDistinctDays, e.dates.length)),
            n = 1 === e.dates.length ? this.renderResourceRow(e.resources) : this.datesAboveResources ? this.renderDayAndResourceRows(e.dates, e.resources) : this.renderResourceAndDayRows(e.resources, e.dates),
        ...
        t.prototype.buildTr = function(e) {
            return e.length || (e = ["<td>&nbsp;</td>"]),
            this.props.renderIntroHtml && (e = [this.props.renderIntroHtml()].concat(e)),
            this.context.isRtl && e.reverse(),
            "<tr>" + e.join("") + "</tr>"
        }
        ,
      ...
      , U = function() {
        function e(e, r) {
            this.dayTable = e,
            this.resources = r,
            this.resourceIndex = new B(r),
            this.rowCnt = e.rowCnt,
            this.colCnt = e.colCnt * r.length,
      ...
      , A = function(e) {
        ...
        return n(r, e),
        r.prototype.computeCol = function(e, r) {
      ...
      , N = function() {
        function e() {
            this.joinDateSelection = r.memoize(this.joinSegs),
            this.joinBusinessHours = r.memoize(this.joinSegs),
            this.joinFgEvents = r.memoize(this.joinSegs),
            this.joinBgEvents = r.memoize(this.joinSegs),
            this.joinEventDrags = r.memoize(this.joinInteractions),
            this.joinEventResizes = r.memoize(this.joinInteractions)
        }
        return e.prototype.joinProps = function(e, r) {
            for (var t = [], n = [], o = [], s = [], i = [], u = [], a = "", c = 0, l = r.resourceIndex.ids.concat([""]); c < l.length; c++) {
                var d = l[c]
                  , p = e[d];
                t.push(p.dateSelectionSegs),
                n.push(d ? p.businessHourSegs : M),
                o.push(d ? p.fgEventSegs : M),
                s.push(p.bgEventSegs),
                i.push(p.eventDrag),
                u.push(p.eventResize),
                a = a || p.eventSelection
            }
            return {
            ...
            for (var a = 0; a < r.length; a++) {
                ...
                if (l)
                    if (n) {
                        var d = t.length
                          , p = o.length;
                        if (e(c.children, t, n, o.concat(0), s, i, u),
                        d < t.length) {
                            var f = t[d];
    ...
    function K(e, t, n) {
        ...
        for (o = 0; o < t.length; o++) {
            if (r.compareByFieldSpecs(t[o].resourceFields, e.resourceFields, n) > 0)
                break
        }
        t.splice(o, 0, e)
    }
    ...
    var q = r.createPlugin({
            ...
            var n = g(e.resourceSource, r, e.dateProfile, t)
              ...
              , i = function(e, r) {
                ...
                case "SET_RESOURCE_ENTITY_EXPANDED":
                    return o({}, e, ((t = {})[r.id] = r.isExpanded,
                    t));
                default:
                    return e
                }
        ...
        eventDefParsers: [function(e, t, n) {
            var o = r.refineProps(t, C, {}, n)
              , s = o.resourceIds;
            o.resourceId && s.push(o.resourceId),
            e.resourceIds = s,
            e.resourceEditable = o.resourceEditable
        }
        ],
        ...
        eventDefMutationAppliers: [function(e, r, t) {
            ...
            if (n && s(e, t)) {
                ...
                if (-1 !== o) {
                    ...
                    i.splice(o, 1),
                    -1 === i.indexOf(n.setResourceId) && i.push(n.setResourceId),
                    e.resourceIds = i
                }
            }
        }
        ...
        dateSelectionTransformers: [function(e, r) {
            ...
            if (t && n)
                return (!1 !== e.component.allowAcrossResources || t === n) && {
                    resourceId: t
                }
        }
        ],
        ...
        eventResizeJoinTransforms: [function(e, r) {
            if (!1 === e.component.allowAcrossResources && e.dateSpan.resourceId !== r.dateSpan.resourceId)
                return !1
        }
        ],
        viewContainerModifiers: [function(e, t) {
            ...
            /\w+\:\/\/fullcalendar\.io\/|\/examples\/[\w-]+\.html$/.test(n) || function(e) {
                if (-1 !== x.indexOf(e))
                    return !0;
    ...
    e.AbstractResourceDayTable = U,
    e.DayResourceTable = H,
    e.ResourceApi = _,
    e.ResourceDayHeader = F,
    e.ResourceDayTable = A,
    e.ResourceSplitter = w,
    e.VResourceJoiner = N,
    e.VResourceSplitter = z,
    e.buildResourceFields = L,
    e.buildResourceTextFunc = j,
    e.buildRowNodes = V,
    e.default = q,
    e.flattenResources = function(e, r) {

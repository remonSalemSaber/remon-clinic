    ...
    var l = function() {
      ...
      , c = function(e) {
        function i(r) {
            ...
            return o.splitter = new t.VResourceSplitter,
            o.slicers = {},
            o.joiner = new d,
            o.dayGrid = r,
            o
        ...
        return a(i, e),
        i.prototype.firstContext = function(e) {
        ...
        i.prototype.render = function(e, t) {
            ...
            n.allowAcrossResources = 1 === a.dayTable.colCnt,
            n.receiveProps(l({}, this.joiner.joinProps(u, a), {
                dateProfile: s,
                cells: a.cells,
                isRigid: e.isRigid
            }), t)
      ...
      , u = function(e) {
        function o() {
            ...
            return o.flattenResources = r.memoize(t.flattenResources),
            o.buildResourceDayTable = r.memoize(p),
            o
        }
        return a(o, e),
        o.prototype._processOptions = function(t) {
            e.prototype._processOptions.call(this, t),
            this.resourceOrderSpecs = r.parseFieldSpecs(t.resourceOrder)
        }
        ,
        ...
        o.prototype._renderSkeleton = function(r) {
            ...
            this.resourceDayGrid = new c(this.dayGrid)
        }
        ,
